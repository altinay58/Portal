...
;(function(window, document) {
  ...
  function closeModal() {
    ...
    //SONRADAN EKLENMÝÞTÝR [YUNUS EMRE ALTINAY - 12.05.2016 13:33]
      //MESAJ HÝZALAMASINI VARSAYILAN AYARLARA DÖNDÜRMEK ÝÇÝN YAZILMIÞTIR.
    $('.sweet-alert p').removeClass('ta-l');
    $('.sweet-alert p').removeClass('ta-r');
    $('.sweet-alert p').removeClass('ta-c');
